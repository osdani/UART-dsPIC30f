...
void init_UART1(void) {
    ...
    U1MODEbits.ALTIO = 0; // se escoge el uart alternativoU1TX y U1RX 
    ...
    U1STAbits.UTXBF = 0; //El b�fer de transmisi�n no est� lleno, se puede escribir al menos una palabra de datos m�s
    ...
    U1STAbits.RIDLE = 0; //Bit de inactividad del receptor (s�lo lectura)  Data is being received
...
void init_UART2(void) {
    ...
    U2STAbits.UTXBF = 0; //El b�fer de transmisi�n no est� lleno, se puede escribir al menos una palabra de datos m�s
    ...
    U2STAbits.RIDLE = 0; //Bit de inactividad del receptor (s�lo lectura)  Data is being received
